...
<body>
        ...
        <form method="POST">
            ...
            <div class="form-column">
                <div class="form-group">
                    ...
                    <input type="text" name="office[0]" autocomplete="off" required />
                </div>
                <div class="form-group">
                    <label for="contract_number">Contract Number:</label>
                    <input type="text" name="contract_number[0]" autocomplete="off" required/>
                </div>
                <div class="form-group">
                    <label for="start_date">Startdate (ex. January 1, 1970):</label>
                    <input type="text" name="start_date[0]" autocomplete="off" required/>
                </div>
                <div class="form-group">
                    <label for="end_date">Enddate (ex. January 1, 1970):</label>
                    <input type="text" name="end_date[0]" autocomplete="off" required/>
                </div>
                <div class="form-group">
                    <label for="rendered">Rendered (in months):</label>
                    <input type="text" name="rendered[0]" autocomplete="off" required/>
                </div>
            </div><hr>
            <div class="contract-group">
                <input type="checkbox" id="showSecondContract" name="showSecondContract">
            ...
            <div class="contract-group">
                <input type="checkbox" id="showThirdContract" name="showThirdContract">
            ...
            <div class="contract-group">
                <input type="checkbox" id="showFourthContract" name="showFourthContract">
    ...
    <script>
        function toggleContractFields(checkbox, fieldsId) {
            const contractFields = document.getElementById(fieldsId);
            if (checkbox.checked) {
        ...
        secondContractCheckbox.addEventListener("change", () => {
            toggleContractFields(secondContractCheckbox, "secondContractFields");
        });

        thirdContractCheckbox.addEventListener("change", () => {
            toggleContractFields(thirdContractCheckbox, "thirdContractFields");
        });

        fourthContractCheckbox.addEventListener("change", () => {
            toggleContractFields(fourthContractCheckbox, "fourthContractFields");
        });
